...
//     header("Location: http://localhost/PHP_Projects/Blog_CMS/blog");
// }

include 'header.php';
include 'config.php';
if (isset($_GET['id'])) {
    $auth_id = intval($_GET['id']);
}
?>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    <h2 class="page-heading"><?php echo strtoupper($row0['first_name']); ?> </h2>
                    <?php
                    }
                    $limit = 3;
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <a class="post-img" href="single.php?id=<?php echo $row['post_id']; ?>"><img
                                        src="admin/uploaded/<?php echo $row['post_img']; ?>" alt="" /></a>
                            </div>
                            <div class="col-md-8">
                                <div class="inner-content clearfix">
                                    ...
                                    <div class="post-information">
                                        <span>
                                            ...
                                            <a
                                                href='category.php?id=<?php echo $row['category'] ?>'><?php echo $row['category_name']; ?></a>
                                        </span>
                                        <span>
                                            <i class="fa fa-user" aria-hidden="true"></i>
                                            <a
                                                href='author.php?id=<?php echo $row['author'] ?>'><?php echo $row['username']; ?></a>
                                        </span>
                                        <span>
                    ...
                    $sql1 = "SELECT COUNT(*) as total_posts FROM post WHERE author = {$auth_id}";

                    // $sql1 = "SELECT post FROM category WHERE category_id = {$auth_id} ";
                    $result1 = mysqli_query($conn, $sql1);
                    $row1 = mysqli_fetch_assoc($result1);

                    if ($row1['total_posts'] > $limit) {
