...
//     header("Location: http://localhost/PHP_Projects/Blog_CMS/");
// }
include 'header.php';
include 'config.php';
if (isset($_GET['id'])) {
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    <?php
                    $sql0 = "SELECT * FROM category WHERE category_id = {$cat_id}";
                    $result0 = mysqli_query($conn, $sql0);
                    if ($row0 = mysqli_fetch_assoc($result0)) {
                    ?>

                        <h2 class="page-heading"><?php echo strtoupper($row0['category_name']); ?> </h2>
                        <?php
                    }
                    $limit = 3;
                    ...
                    $sql1 = "SELECT COUNT(*) as total_posts FROM post WHERE category = {$cat_id}";
